document.addEventListener('DOMContentLoaded', () => {
    ...
    /**
     * Genera los cuadros interactivos para cada carácter japonés.
     * @param {string} text El texto a generar.
     */
    const generateJapaneseSquares = (text) => {
        japaneseWritingGrid.innerHTML = ''; // Limpia la cuadrícula actual
            ...
            if (phrase.length > 0) {
                ...
                for (const char of phrase) {
                    ...
                    squareContainer.addEventListener('click', () => {
                        ...
                        ctx.fillStyle = '#333';
                        ctx.font = '72px Arial'; // Puedes ajustar la fuente para japonés si es necesario
    ...
    // Lógica para el botón de descarga de PDF
    ...
    // Generar la palabra "konnichiwa" por defecto al cargar la página
